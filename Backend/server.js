...
app.use((req, res, next) => {
  ...
  const U=mongo.model('registrations');
...
app.get('/getuser/:email', (req,res)=> {
  ...
  //app.get('/getuser/:email',registrationsController.getuserdata)
  ...
  app.get('/Packages/:Place', function(req, res) {
    ...
    console.log(index);
    const Package_Id=Packages[index].id;
...
app.get('/',(req,res)=>{
    ...
    res.send('Welcome to Karunadu Tourism API');
...
app.listen(5000, function () {
    console.log('Karunadu App listening on port 5000!')
  })
